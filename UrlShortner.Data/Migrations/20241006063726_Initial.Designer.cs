...
namespace UrlShortner.Data.Migrations
{
    ...
    [Migration("20241006063726_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UrlShortner.Data.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("UrlShortner.Data.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UrlShortner.Data.Models.Url", b =>
                {
                    b.HasOne("UrlShortner.Data.Models.User", "User")
                        .WithMany("Urls")
                        .HasForeignKey("UserId");
